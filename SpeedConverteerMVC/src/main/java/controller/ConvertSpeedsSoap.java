...
public interface ConvertSpeedsSoap {
    ...
    @RequestWrapper(localName = "ConvertSpeed", targetNamespace = "http://www.webserviceX.NET/", className = "controlador.ConvertSpeed")
    @ResponseWrapper(localName = "ConvertSpeedResponse", targetNamespace = "http://www.webserviceX.NET/", className = "controlador.ConvertSpeedResponse")
