...
public interface ConvertSpeedsSoap {
    ...
    @RequestWrapper(localName = "ConvertSpeed", targetNamespace = "http://www.webserviceX.NET/", className = "ConvertSpeed")
    @ResponseWrapper(localName = "ConvertSpeedResponse", targetNamespace = "http://www.webserviceX.NET/", className = "ConvertSpeedResponse")
